...
export type Parameters = [ReferenceDenormalizer, EnsureRange, EvalContext];
...
export class CompilationParameters {
  ...
  constructor(computeCell: (rc: string) => EvaluatedCell, getters: Getters) {
    this.computeCell = computeCell;
    this.getters = getters;
  }

  getParameters(evalContext: EvalContext): Parameters {
    const context = Object.assign(Object.create(functionMap), evalContext, {
      getters: this.getters,
    });
    return [this.refFn, this.range, context];
  }
