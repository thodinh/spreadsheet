...
describe("LOOKUP formula", () => {
  ...
  test("can't lookup an error values", () => {
    const grid = {
      A1: "=1/0",
      B1: "1",
      A2: "42",
...
describe("VLOOKUP formula", () => {
  ...
  test("VLOOKUP can't find error values", () => {
    // prettier-ignore
    const grid = {
      A1: "=KABOUM", B1: "1",
      A2: "42",      B2: "2", 
...
describe("HLOOKUP formula", () => {
  ...
  test("HLOOKUP can't find error values", () => {
    // prettier-ignore
    const grid = {
      A1: "=KABOUM", B1: "42",
      A2: "1",       B2: "2", 
...
describe("XLOOKUP formula", () => {
  ...
  describe("match_mode argument", () => {
    ...
    test("XLOOKUP can't find error values", () => {
      // prettier-ignore
      const grid = {
        A1: "=KABOUM", B1: "42",
        A2: "1",       B2: "2", 
